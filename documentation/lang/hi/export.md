---
title: glTF में एसेट एक्सपोर्ट करना
---
...
आप सीन और Prefabs को मल्टीपल glTF फ़ाइलों में विभाजित कर सकते हैं, और फिर आवश्यकता पड़ने पर उन्हें लोड कर सकते हैं (केवल तभी जब उनकी आवश्यकता हो)। इससे लोडिंग प्रदर्शन तेज़ रहता है और फ़ाइल का साइज़ छोटा रहता है। [स्क्रिप्टिंग डॉक्स में AssetReference अनुभाग](scripting.md#assetreference-and-addressables) देखें।
...
Prefabs एक्सपोर्ट करना नेस्टिंग के साथ भी काम करता है: एक Prefab में एक कंपोनेंट दूसरे Prefab को रेफरेंस कर सकता है जिसे फिर एक्सपोर्ट भी किया जाएगा।
...
Needle Engine नए [glTF एक्सटेंशन KHR_ANIMATION_POINTER](https://github.com/ux3d/glTF/tree/extensions/KHR_animation_pointer/extensions/2.0/Khronos/KHR_animation_pointer) को सपोर्ट करने वाला पहला है।
...
ध्यान दें कि **कस्टम शेडर** आधिकारिक तौर पर glTF स्पेसिफिकेशन का हिस्सा नहीं हैं। कस्टम शेडर का हमारा कार्यान्वयन KHR_techniques_webgl नामक एक एक्सटेंशन का उपयोग करता है, जो WebGL शेडर कोड को सीधे glTF फ़ाइल में संग्रहीत करता है। परिणामी एसेट Needle Engine पर आधारित व्यूअर में काम करेंगे।
:::
