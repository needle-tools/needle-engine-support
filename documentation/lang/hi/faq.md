...
- mixed (लाइटमैपिंग के साथ) पर सेट लाइट तीन.js में वस्तुओं को दो बार प्रभावित करती हैं, क्योंकि वर्तमान में लाइटमैप किए गए वस्तुओं को लाइटिंग से बाहर करने का कोई तरीका नहीं है
...
- सुनिश्चित करें कि स्थानीय रनटाइम पैकेज (``node_modules/@needle-tools/engine``) और तीन.js (``node_modules/three``) दोनों इंस्टॉल हो गए हैं।
...
यह तब हो सकता है जब आपके पास उदा. एक `SceneSwitcher` (या कोई अन्य कंपोनेंट जो एक सीन या एसेट लोड करता है) हो और Unity में संदर्भित Asset में एक `GltfObject` हो जिसका नाम आपके मूल सीन के नाम जैसा ही हो जिसमें `SceneSwitcher` है।
यदि आपको कोई ऐसी त्रुटि मिलती है जो कुछ इस तरह कहती है तो आप Unity में इसकी दोबारा जांच कर सकते हैं:
