[com.needle.engine - v2.39.0-pre](../README.md) / XRRig
...
- [gameObject](XRRig.md#gameobject)
- [guid](XRRig.md#guid)
- [sourceId](XRRig.md#sourceid)

### Accessors

- [activeAndEnabled](XRRig.md#activeandenabled)
- [context](XRRig.md#context)
- [destroyed](XRRig.md#destroyed)
- [enabled](XRRig.md#enabled)
- [forward](XRRig.md#forward)
- [hideFlags](XRRig.md#hideflags)
- [isComponent](XRRig.md#iscomponent)
- [layer](XRRig.md#layer)
- [name](XRRig.md#name)
- [scene](XRRig.md#scene)
- [static](XRRig.md#static)
- [tag](XRRig.md#tag)
- [worldEuler](XRRig.md#worldeuler)
- [worldPosition](XRRig.md#worldposition)
- [worldQuaternion](XRRig.md#worldquaternion)
- [worldRotation](XRRig.md#worldrotation)

### Methods

- [addEventListener](XRRig.md#addeventlistener)
- [awake](XRRig.md#awake)
- [destroy](XRRig.md#destroy)
- [dispatchEvent](XRRig.md#dispatchevent)
- [earlyUpdate](XRRig.md#earlyupdate)
- [lateUpdate](XRRig.md#lateupdate)
- [onAfterRender](XRRig.md#onafterrender)
- [onBeforeRender](XRRig.md#onbeforerender)
- [onCollisionEnter](XRRig.md#oncollisionenter)
- [onCollisionExit](XRRig.md#oncollisionexit)
- [onCollisionStay](XRRig.md#oncollisionstay)
- [onDestroy](XRRig.md#ondestroy)
- [onDisable](XRRig.md#ondisable)
- [onEnable](XRRig.md#onenable)
- [onTriggerEnter](XRRig.md#ontriggerenter)
- [onTriggerExit](XRRig.md#ontriggerexit)
- [onTriggerStay](XRRig.md#ontriggerstay)
- [onValidate](XRRig.md#onvalidate)
- [removeEventListener](XRRig.md#removeeventlistener)
- [resolveGuids](XRRig.md#resolveguids)
- [setWorldPosition](XRRig.md#setworldposition)
- [setWorldQuaternion](XRRig.md#setworldquaternion)
- [setWorldRotation](XRRig.md#setworldrotation)
- [start](XRRig.md#start)
- [startCoroutine](XRRig.md#startcoroutine)
- [stopCoroutine](XRRig.md#stopcoroutine)
- [update](XRRig.md#update)
