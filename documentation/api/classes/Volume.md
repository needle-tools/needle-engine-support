[com.needle.engine - v2.39.0-pre](../README.md) / Volume
...
- [gameObject](Volume.md#gameobject)
- [guid](Volume.md#guid)
- [sharedProfile](Volume.md#sharedprofile)
- [sourceId](Volume.md#sourceid)

### Accessors

- [activeAndEnabled](Volume.md#activeandenabled)
- [context](Volume.md#context)
- [destroyed](Volume.md#destroyed)
- [enabled](Volume.md#enabled)
- [forward](Volume.md#forward)
- [hideFlags](Volume.md#hideflags)
- [isComponent](Volume.md#iscomponent)
- [layer](Volume.md#layer)
- [name](Volume.md#name)
- [scene](Volume.md#scene)
- [static](Volume.md#static)
- [tag](Volume.md#tag)
- [worldEuler](Volume.md#worldeuler)
- [worldPosition](Volume.md#worldposition)
- [worldQuaternion](Volume.md#worldquaternion)
- [worldRotation](Volume.md#worldrotation)

### Methods

- [addEventListener](Volume.md#addeventlistener)
- [awake](Volume.md#awake)
- [destroy](Volume.md#destroy)
- [dispatchEvent](Volume.md#dispatchevent)
- [earlyUpdate](Volume.md#earlyupdate)
- [lateUpdate](Volume.md#lateupdate)
- [onAfterRender](Volume.md#onafterrender)
- [onBeforeRender](Volume.md#onbeforerender)
- [onCollisionEnter](Volume.md#oncollisionenter)
- [onCollisionExit](Volume.md#oncollisionexit)
- [onCollisionStay](Volume.md#oncollisionstay)
- [onDestroy](Volume.md#ondestroy)
- [onDisable](Volume.md#ondisable)
- [onEnable](Volume.md#onenable)
- [onTriggerEnter](Volume.md#ontriggerenter)
- [onTriggerExit](Volume.md#ontriggerexit)
- [onTriggerStay](Volume.md#ontriggerstay)
- [onValidate](Volume.md#onvalidate)
- [removeEventListener](Volume.md#removeeventlistener)
- [resolveGuids](Volume.md#resolveguids)
- [setWorldPosition](Volume.md#setworldposition)
- [setWorldQuaternion](Volume.md#setworldquaternion)
- [setWorldRotation](Volume.md#setworldrotation)
- [start](Volume.md#start)
- [startCoroutine](Volume.md#startcoroutine)
- [stopCoroutine](Volume.md#stopcoroutine)
- [update](Volume.md#update)
...
• `Optional` **sharedProfile**: [`VolumeProfile`](VolumeProfile.md)
