[com.needle.engine - v2.39.0-pre](../README.md) / SpriteRenderer
...
- [color](SpriteRenderer.md#color)
- [drawMode](SpriteRenderer.md#drawmode)
- [gameObject](SpriteRenderer.md#gameobject)
- [guid](SpriteRenderer.md#guid)
- [sharedMaterial](SpriteRenderer.md#sharedmaterial)
- [size](SpriteRenderer.md#size)
- [sourceId](SpriteRenderer.md#sourceid)

### Accessors

- [activeAndEnabled](SpriteRenderer.md#activeandenabled)
- [context](SpriteRenderer.md#context)
- [destroyed](SpriteRenderer.md#destroyed)
- [enabled](SpriteRenderer.md#enabled)
- [forward](SpriteRenderer.md#forward)
- [hideFlags](SpriteRenderer.md#hideflags)
- [isComponent](SpriteRenderer.md#iscomponent)
- [layer](SpriteRenderer.md#layer)
- [name](SpriteRenderer.md#name)
- [scene](SpriteRenderer.md#scene)
- [sprite](SpriteRenderer.md#sprite)
- [static](SpriteRenderer.md#static)
- [tag](SpriteRenderer.md#tag)
- [worldEuler](SpriteRenderer.md#worldeuler)
- [worldPosition](SpriteRenderer.md#worldposition)
- [worldQuaternion](SpriteRenderer.md#worldquaternion)
- [worldRotation](SpriteRenderer.md#worldrotation)

### Methods

- [addEventListener](SpriteRenderer.md#addeventlistener)
- [awake](SpriteRenderer.md#awake)
- [destroy](SpriteRenderer.md#destroy)
- [dispatchEvent](SpriteRenderer.md#dispatchevent)
- [earlyUpdate](SpriteRenderer.md#earlyupdate)
- [lateUpdate](SpriteRenderer.md#lateupdate)
- [onAfterRender](SpriteRenderer.md#onafterrender)
- [onBeforeRender](SpriteRenderer.md#onbeforerender)
- [onCollisionEnter](SpriteRenderer.md#oncollisionenter)
- [onCollisionExit](SpriteRenderer.md#oncollisionexit)
- [onCollisionStay](SpriteRenderer.md#oncollisionstay)
- [onDestroy](SpriteRenderer.md#ondestroy)
- [onDisable](SpriteRenderer.md#ondisable)
- [onEnable](SpriteRenderer.md#onenable)
- [onTriggerEnter](SpriteRenderer.md#ontriggerenter)
- [onTriggerExit](SpriteRenderer.md#ontriggerexit)
- [onTriggerStay](SpriteRenderer.md#ontriggerstay)
- [onValidate](SpriteRenderer.md#onvalidate)
- [removeEventListener](SpriteRenderer.md#removeeventlistener)
- [resolveGuids](SpriteRenderer.md#resolveguids)
- [setWorldPosition](SpriteRenderer.md#setworldposition)
- [setWorldQuaternion](SpriteRenderer.md#setworldquaternion)
- [setWorldRotation](SpriteRenderer.md#setworldrotation)
- [start](SpriteRenderer.md#start)
- [startCoroutine](SpriteRenderer.md#startcoroutine)
- [stopCoroutine](SpriteRenderer.md#stopcoroutine)
...
• `Optional` **color**: [`RGBAColor`](RGBAColor.md)
...
• `Optional` **sharedMaterial**: `Material`
...
• `get` **sprite**(): `undefined` \| [`Sprite`](Sprite.md)

#### Returns

`undefined` \| [`Sprite`](Sprite.md)
...
| Name | Type |
| :------ | :------ |
| `value` | `undefined` \| [`Sprite`](Sprite.md) |
