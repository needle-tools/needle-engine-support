[com.needle.engine - v2.39.0-pre](../README.md) / AudioListener
...
- [gameObject](AudioListener.md#gameobject)
- [guid](AudioListener.md#guid)
- [sourceId](AudioListener.md#sourceid)

### Accessors

- [activeAndEnabled](AudioListener.md#activeandenabled)
- [context](AudioListener.md#context)
- [destroyed](AudioListener.md#destroyed)
- [enabled](AudioListener.md#enabled)
- [forward](AudioListener.md#forward)
- [hideFlags](AudioListener.md#hideflags)
- [isComponent](AudioListener.md#iscomponent)
- [layer](AudioListener.md#layer)
- [listener](AudioListener.md#listener)
- [name](AudioListener.md#name)
- [scene](AudioListener.md#scene)
- [static](AudioListener.md#static)
- [tag](AudioListener.md#tag)
- [worldEuler](AudioListener.md#worldeuler)
- [worldPosition](AudioListener.md#worldposition)
- [worldQuaternion](AudioListener.md#worldquaternion)
- [worldRotation](AudioListener.md#worldrotation)

### Methods

- [addEventListener](AudioListener.md#addeventlistener)
- [awake](AudioListener.md#awake)
- [destroy](AudioListener.md#destroy)
- [dispatchEvent](AudioListener.md#dispatchevent)
- [earlyUpdate](AudioListener.md#earlyupdate)
- [lateUpdate](AudioListener.md#lateupdate)
- [onAfterRender](AudioListener.md#onafterrender)
- [onBeforeRender](AudioListener.md#onbeforerender)
- [onCollisionEnter](AudioListener.md#oncollisionenter)
- [onCollisionExit](AudioListener.md#oncollisionexit)
- [onCollisionStay](AudioListener.md#oncollisionstay)
- [onDestroy](AudioListener.md#ondestroy)
- [onDisable](AudioListener.md#ondisable)
- [onEnable](AudioListener.md#onenable)
- [onTriggerEnter](AudioListener.md#ontriggerenter)
- [onTriggerExit](AudioListener.md#ontriggerexit)
- [onTriggerStay](AudioListener.md#ontriggerstay)
- [onValidate](AudioListener.md#onvalidate)
- [removeEventListener](AudioListener.md#removeeventlistener)
- [resolveGuids](AudioListener.md#resolveguids)
- [setWorldPosition](AudioListener.md#setworldposition)
- [setWorldQuaternion](AudioListener.md#setworldquaternion)
- [setWorldRotation](AudioListener.md#setworldrotation)
- [start](AudioListener.md#start)
- [startCoroutine](AudioListener.md#startcoroutine)
- [stopCoroutine](AudioListener.md#stopcoroutine)
- [update](AudioListener.md#update)
