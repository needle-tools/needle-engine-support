[com.needle.engine - v2.39.0-pre](../README.md) / DeviceFlag
...
- [gameObject](DeviceFlag.md#gameobject)
- [guid](DeviceFlag.md#guid)
- [sourceId](DeviceFlag.md#sourceid)
- [visibleOn](DeviceFlag.md#visibleon)

### Accessors

- [activeAndEnabled](DeviceFlag.md#activeandenabled)
- [context](DeviceFlag.md#context)
- [destroyed](DeviceFlag.md#destroyed)
- [enabled](DeviceFlag.md#enabled)
- [forward](DeviceFlag.md#forward)
- [hideFlags](DeviceFlag.md#hideflags)
- [isComponent](DeviceFlag.md#iscomponent)
- [layer](DeviceFlag.md#layer)
- [name](DeviceFlag.md#name)
- [scene](DeviceFlag.md#scene)
- [static](DeviceFlag.md#static)
- [tag](DeviceFlag.md#tag)
- [worldEuler](DeviceFlag.md#worldeuler)
- [worldPosition](DeviceFlag.md#worldposition)
- [worldQuaternion](DeviceFlag.md#worldquaternion)
- [worldRotation](DeviceFlag.md#worldrotation)

### Methods

- [addEventListener](DeviceFlag.md#addeventlistener)
- [apply](DeviceFlag.md#apply)
- [awake](DeviceFlag.md#awake)
- [destroy](DeviceFlag.md#destroy)
- [dispatchEvent](DeviceFlag.md#dispatchevent)
- [earlyUpdate](DeviceFlag.md#earlyupdate)
- [lateUpdate](DeviceFlag.md#lateupdate)
- [onAfterRender](DeviceFlag.md#onafterrender)
- [onBeforeRender](DeviceFlag.md#onbeforerender)
- [onCollisionEnter](DeviceFlag.md#oncollisionenter)
- [onCollisionExit](DeviceFlag.md#oncollisionexit)
- [onCollisionStay](DeviceFlag.md#oncollisionstay)
- [onDestroy](DeviceFlag.md#ondestroy)
- [onDisable](DeviceFlag.md#ondisable)
- [onEnable](DeviceFlag.md#onenable)
- [onTriggerEnter](DeviceFlag.md#ontriggerenter)
- [onTriggerExit](DeviceFlag.md#ontriggerexit)
- [onTriggerStay](DeviceFlag.md#ontriggerstay)
- [onValidate](DeviceFlag.md#onvalidate)
- [removeEventListener](DeviceFlag.md#removeeventlistener)
- [resolveGuids](DeviceFlag.md#resolveguids)
- [setWorldPosition](DeviceFlag.md#setworldposition)
- [setWorldQuaternion](DeviceFlag.md#setworldquaternion)
- [setWorldRotation](DeviceFlag.md#setworldrotation)
- [start](DeviceFlag.md#start)
- [startCoroutine](DeviceFlag.md#startcoroutine)
- [stopCoroutine](DeviceFlag.md#stopcoroutine)
- [update](DeviceFlag.md#update)
