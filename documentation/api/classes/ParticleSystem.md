[com.needle.engine - v2.39.0-pre](../README.md) / ParticleSystem
...
- [emission](ParticleSystem.md#emission)
- [gameObject](ParticleSystem.md#gameobject)
- [guid](ParticleSystem.md#guid)
- [main](ParticleSystem.md#main)
- [shape](ParticleSystem.md#shape)
- [sourceId](ParticleSystem.md#sourceid)

### Accessors

- [activeAndEnabled](ParticleSystem.md#activeandenabled)
- [context](ParticleSystem.md#context)
- [destroyed](ParticleSystem.md#destroyed)
- [enabled](ParticleSystem.md#enabled)
- [forward](ParticleSystem.md#forward)
- [hideFlags](ParticleSystem.md#hideflags)
- [isComponent](ParticleSystem.md#iscomponent)
- [layer](ParticleSystem.md#layer)
- [name](ParticleSystem.md#name)
- [scene](ParticleSystem.md#scene)
- [static](ParticleSystem.md#static)
- [tag](ParticleSystem.md#tag)
- [worldEuler](ParticleSystem.md#worldeuler)
- [worldPosition](ParticleSystem.md#worldposition)
- [worldQuaternion](ParticleSystem.md#worldquaternion)
- [worldRotation](ParticleSystem.md#worldrotation)

### Methods

- [addEventListener](ParticleSystem.md#addeventlistener)
- [awake](ParticleSystem.md#awake)
- [destroy](ParticleSystem.md#destroy)
- [dispatchEvent](ParticleSystem.md#dispatchevent)
- [earlyUpdate](ParticleSystem.md#earlyupdate)
- [emit](ParticleSystem.md#emit)
- [lateUpdate](ParticleSystem.md#lateupdate)
- [onAfterRender](ParticleSystem.md#onafterrender)
- [onBeforeRender](ParticleSystem.md#onbeforerender)
- [onCollisionEnter](ParticleSystem.md#oncollisionenter)
- [onCollisionExit](ParticleSystem.md#oncollisionexit)
- [onCollisionStay](ParticleSystem.md#oncollisionstay)
- [onDestroy](ParticleSystem.md#ondestroy)
- [onDisable](ParticleSystem.md#ondisable)
- [onEnable](ParticleSystem.md#onenable)
- [onTriggerEnter](ParticleSystem.md#ontriggerenter)
- [onTriggerExit](ParticleSystem.md#ontriggerexit)
- [onTriggerStay](ParticleSystem.md#ontriggerstay)
- [onValidate](ParticleSystem.md#onvalidate)
- [removeEventListener](ParticleSystem.md#removeeventlistener)
- [resolveGuids](ParticleSystem.md#resolveguids)
- [setWorldPosition](ParticleSystem.md#setworldposition)
- [setWorldQuaternion](ParticleSystem.md#setworldquaternion)
- [setWorldRotation](ParticleSystem.md#setworldrotation)
- [start](ParticleSystem.md#start)
- [startCoroutine](ParticleSystem.md#startcoroutine)
- [stopCoroutine](ParticleSystem.md#stopcoroutine)
- [update](ParticleSystem.md#update)

## Properties

### emission

• **emission**: [`EmissionModule`](EmissionModule.md)
...
• **main**: [`MainModule`](MainModule.md)

___

### shape

• **shape**: [`ShapeModule`](ShapeModule.md)
