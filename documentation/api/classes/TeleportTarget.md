[com.needle.engine - v2.39.0-pre](../README.md) / TeleportTarget
...
- [gameObject](TeleportTarget.md#gameobject)
- [guid](TeleportTarget.md#guid)
- [sourceId](TeleportTarget.md#sourceid)

### Accessors

- [activeAndEnabled](TeleportTarget.md#activeandenabled)
- [context](TeleportTarget.md#context)
- [destroyed](TeleportTarget.md#destroyed)
- [enabled](TeleportTarget.md#enabled)
- [forward](TeleportTarget.md#forward)
- [hideFlags](TeleportTarget.md#hideflags)
- [isComponent](TeleportTarget.md#iscomponent)
- [layer](TeleportTarget.md#layer)
- [name](TeleportTarget.md#name)
- [scene](TeleportTarget.md#scene)
- [static](TeleportTarget.md#static)
- [tag](TeleportTarget.md#tag)
- [worldEuler](TeleportTarget.md#worldeuler)
- [worldPosition](TeleportTarget.md#worldposition)
- [worldQuaternion](TeleportTarget.md#worldquaternion)
- [worldRotation](TeleportTarget.md#worldrotation)

### Methods

- [addEventListener](TeleportTarget.md#addeventlistener)
- [awake](TeleportTarget.md#awake)
- [destroy](TeleportTarget.md#destroy)
- [dispatchEvent](TeleportTarget.md#dispatchevent)
- [earlyUpdate](TeleportTarget.md#earlyupdate)
- [lateUpdate](TeleportTarget.md#lateupdate)
- [onAfterRender](TeleportTarget.md#onafterrender)
- [onBeforeRender](TeleportTarget.md#onbeforerender)
- [onCollisionEnter](TeleportTarget.md#oncollisionenter)
- [onCollisionExit](TeleportTarget.md#oncollisionexit)
- [onCollisionStay](TeleportTarget.md#oncollisionstay)
- [onDestroy](TeleportTarget.md#ondestroy)
- [onDisable](TeleportTarget.md#ondisable)
- [onEnable](TeleportTarget.md#onenable)
- [onTriggerEnter](TeleportTarget.md#ontriggerenter)
- [onTriggerExit](TeleportTarget.md#ontriggerexit)
- [onTriggerStay](TeleportTarget.md#ontriggerstay)
- [onValidate](TeleportTarget.md#onvalidate)
- [removeEventListener](TeleportTarget.md#removeeventlistener)
- [resolveGuids](TeleportTarget.md#resolveguids)
- [setWorldPosition](TeleportTarget.md#setworldposition)
- [setWorldQuaternion](TeleportTarget.md#setworldquaternion)
- [setWorldRotation](TeleportTarget.md#setworldrotation)
- [start](TeleportTarget.md#start)
- [startCoroutine](TeleportTarget.md#startcoroutine)
- [stopCoroutine](TeleportTarget.md#stopcoroutine)
- [update](TeleportTarget.md#update)
