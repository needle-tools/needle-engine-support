[com.needle.engine - v2.39.0-pre](../README.md) / Raycaster
...
- [gameObject](Raycaster.md#gameobject)
- [guid](Raycaster.md#guid)
- [sourceId](Raycaster.md#sourceid)

### Accessors

- [activeAndEnabled](Raycaster.md#activeandenabled)
- [context](Raycaster.md#context)
- [destroyed](Raycaster.md#destroyed)
- [enabled](Raycaster.md#enabled)
- [forward](Raycaster.md#forward)
- [hideFlags](Raycaster.md#hideflags)
- [isComponent](Raycaster.md#iscomponent)
- [layer](Raycaster.md#layer)
- [name](Raycaster.md#name)
- [scene](Raycaster.md#scene)
- [static](Raycaster.md#static)
- [tag](Raycaster.md#tag)
- [worldEuler](Raycaster.md#worldeuler)
- [worldPosition](Raycaster.md#worldposition)
- [worldQuaternion](Raycaster.md#worldquaternion)
- [worldRotation](Raycaster.md#worldrotation)

### Methods

- [addEventListener](Raycaster.md#addeventlistener)
- [awake](Raycaster.md#awake)
- [destroy](Raycaster.md#destroy)
- [dispatchEvent](Raycaster.md#dispatchevent)
- [earlyUpdate](Raycaster.md#earlyupdate)
- [lateUpdate](Raycaster.md#lateupdate)
- [onAfterRender](Raycaster.md#onafterrender)
- [onBeforeRender](Raycaster.md#onbeforerender)
- [onCollisionEnter](Raycaster.md#oncollisionenter)
- [onCollisionExit](Raycaster.md#oncollisionexit)
- [onCollisionStay](Raycaster.md#oncollisionstay)
- [onDestroy](Raycaster.md#ondestroy)
- [onDisable](Raycaster.md#ondisable)
- [onEnable](Raycaster.md#onenable)
- [onTriggerEnter](Raycaster.md#ontriggerenter)
- [onTriggerExit](Raycaster.md#ontriggerexit)
- [onTriggerStay](Raycaster.md#ontriggerstay)
- [onValidate](Raycaster.md#onvalidate)
- [performRaycast](Raycaster.md#performraycast)
- [removeEventListener](Raycaster.md#removeeventlistener)
- [resolveGuids](Raycaster.md#resolveguids)
- [setWorldPosition](Raycaster.md#setworldposition)
- [setWorldQuaternion](Raycaster.md#setworldquaternion)
- [setWorldRotation](Raycaster.md#setworldrotation)
- [start](Raycaster.md#start)
- [startCoroutine](Raycaster.md#startcoroutine)
- [stopCoroutine](Raycaster.md#stopcoroutine)
- [update](Raycaster.md#update)
...
▸ **performRaycast**(`_opts?`): ``null`` \| `Intersection`<`Object3D`<`Event`\>\>[]

#### Parameters

| Name | Type | Default value |
| :------ | :------ | :------ |
| `_opts` | ``null`` \| `RaycastOptions` | `null` |
