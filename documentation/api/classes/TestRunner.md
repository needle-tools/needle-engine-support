[com.needle.engine - v2.39.0-pre](../README.md) / TestRunner
...
- [gameObject](TestRunner.md#gameobject)
- [guid](TestRunner.md#guid)
- [sourceId](TestRunner.md#sourceid)

### Accessors

- [activeAndEnabled](TestRunner.md#activeandenabled)
- [context](TestRunner.md#context)
- [destroyed](TestRunner.md#destroyed)
- [enabled](TestRunner.md#enabled)
- [forward](TestRunner.md#forward)
- [hideFlags](TestRunner.md#hideflags)
- [isComponent](TestRunner.md#iscomponent)
- [layer](TestRunner.md#layer)
- [name](TestRunner.md#name)
- [scene](TestRunner.md#scene)
- [static](TestRunner.md#static)
- [tag](TestRunner.md#tag)
- [worldEuler](TestRunner.md#worldeuler)
- [worldPosition](TestRunner.md#worldposition)
- [worldQuaternion](TestRunner.md#worldquaternion)
- [worldRotation](TestRunner.md#worldrotation)

### Methods

- [addEventListener](TestRunner.md#addeventlistener)
- [awake](TestRunner.md#awake)
- [destroy](TestRunner.md#destroy)
- [dispatchEvent](TestRunner.md#dispatchevent)
- [earlyUpdate](TestRunner.md#earlyupdate)
- [lateUpdate](TestRunner.md#lateupdate)
- [onAfterRender](TestRunner.md#onafterrender)
- [onBeforeRender](TestRunner.md#onbeforerender)
- [onCollisionEnter](TestRunner.md#oncollisionenter)
- [onCollisionExit](TestRunner.md#oncollisionexit)
- [onCollisionStay](TestRunner.md#oncollisionstay)
- [onDestroy](TestRunner.md#ondestroy)
- [onDisable](TestRunner.md#ondisable)
- [onEnable](TestRunner.md#onenable)
- [onTriggerEnter](TestRunner.md#ontriggerenter)
- [onTriggerExit](TestRunner.md#ontriggerexit)
- [onTriggerStay](TestRunner.md#ontriggerstay)
- [onValidate](TestRunner.md#onvalidate)
- [removeEventListener](TestRunner.md#removeeventlistener)
- [resolveGuids](TestRunner.md#resolveguids)
- [setWorldPosition](TestRunner.md#setworldposition)
- [setWorldQuaternion](TestRunner.md#setworldquaternion)
- [setWorldRotation](TestRunner.md#setworldrotation)
- [start](TestRunner.md#start)
- [startCoroutine](TestRunner.md#startcoroutine)
- [stopCoroutine](TestRunner.md#stopcoroutine)
- [update](TestRunner.md#update)
