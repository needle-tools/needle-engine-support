[com.needle.engine - v2.39.0-pre](../README.md) / Button
...
- [animationTriggers](Button.md#animationtriggers)
- [animator](Button.md#animator)
- [colors](Button.md#colors)
- [gameObject](Button.md#gameobject)
- [guid](Button.md#guid)
- [onClick](Button.md#onclick)
- [sourceId](Button.md#sourceid)
- [transition](Button.md#transition)

### Accessors

- [activeAndEnabled](Button.md#activeandenabled)
- [context](Button.md#context)
- [destroyed](Button.md#destroyed)
- [enabled](Button.md#enabled)
- [forward](Button.md#forward)
- [hideFlags](Button.md#hideflags)
- [interactable](Button.md#interactable)
- [isComponent](Button.md#iscomponent)
- [layer](Button.md#layer)
- [name](Button.md#name)
- [scene](Button.md#scene)
- [static](Button.md#static)
- [tag](Button.md#tag)
- [worldEuler](Button.md#worldeuler)
- [worldPosition](Button.md#worldposition)
- [worldQuaternion](Button.md#worldquaternion)
- [worldRotation](Button.md#worldrotation)

### Methods

- [addEventListener](Button.md#addeventlistener)
- [awake](Button.md#awake)
- [destroy](Button.md#destroy)
- [dispatchEvent](Button.md#dispatchevent)
- [earlyUpdate](Button.md#earlyupdate)
- [lateUpdate](Button.md#lateupdate)
- [onAfterRender](Button.md#onafterrender)
- [onBeforeRender](Button.md#onbeforerender)
- [onCollisionEnter](Button.md#oncollisionenter)
- [onCollisionExit](Button.md#oncollisionexit)
- [onCollisionStay](Button.md#oncollisionstay)
- [onDestroy](Button.md#ondestroy)
- [onDisable](Button.md#ondisable)
- [onEnable](Button.md#onenable)
- [onPointerClick](Button.md#onpointerclick)
- [onPointerDown](Button.md#onpointerdown)
- [onPointerEnter](Button.md#onpointerenter)
- [onPointerExit](Button.md#onpointerexit)
- [onPointerUp](Button.md#onpointerup)
- [onTriggerEnter](Button.md#ontriggerenter)
- [onTriggerExit](Button.md#ontriggerexit)
- [onTriggerStay](Button.md#ontriggerstay)
- [onValidate](Button.md#onvalidate)
- [removeEventListener](Button.md#removeeventlistener)
- [resolveGuids](Button.md#resolveguids)
- [setWorldPosition](Button.md#setworldposition)
- [setWorldQuaternion](Button.md#setworldquaternion)
- [setWorldRotation](Button.md#setworldrotation)
- [start](Button.md#start)
- [startCoroutine](Button.md#startcoroutine)
- [stopCoroutine](Button.md#stopcoroutine)
...
• `Optional` **animationTriggers**: `AnimationTriggers`
...
• `Optional` **onClick**: [`EventList`](EventList.md)
...
IPointerEventHandler.onPointerDown

___

### onPointerEnter

▸ **onPointerEnter**(`_`): `void`
...
IPointerEventHandler.onPointerEnter
...
IPointerEventHandler.onPointerExit
...
IPointerEventHandler.onPointerUp
