[com.needle.engine - v2.39.0-pre](../README.md) / Voip
...
- [gameObject](Voip.md#gameobject)
- [guid](Voip.md#guid)
- [requireParam](Voip.md#requireparam)
- [sourceId](Voip.md#sourceid)

### Accessors

- [activeAndEnabled](Voip.md#activeandenabled)
- [context](Voip.md#context)
- [destroyed](Voip.md#destroyed)
- [enabled](Voip.md#enabled)
- [forward](Voip.md#forward)
- [hideFlags](Voip.md#hideflags)
- [isComponent](Voip.md#iscomponent)
- [layer](Voip.md#layer)
- [muteInput](Voip.md#muteinput)
- [muteOutput](Voip.md#muteoutput)
- [name](Voip.md#name)
- [scene](Voip.md#scene)
- [static](Voip.md#static)
- [tag](Voip.md#tag)
- [worldEuler](Voip.md#worldeuler)
- [worldPosition](Voip.md#worldposition)
- [worldQuaternion](Voip.md#worldquaternion)
- [worldRotation](Voip.md#worldrotation)

### Methods

- [addEventListener](Voip.md#addeventlistener)
- [awake](Voip.md#awake)
- [destroy](Voip.md#destroy)
- [dispatchEvent](Voip.md#dispatchevent)
- [earlyUpdate](Voip.md#earlyupdate)
- [getFrequency](Voip.md#getfrequency)
- [lateUpdate](Voip.md#lateupdate)
- [onAfterRender](Voip.md#onafterrender)
- [onBeforeRender](Voip.md#onbeforerender)
- [onCollisionEnter](Voip.md#oncollisionenter)
- [onCollisionExit](Voip.md#oncollisionexit)
- [onCollisionStay](Voip.md#oncollisionstay)
- [onDestroy](Voip.md#ondestroy)
- [onDisable](Voip.md#ondisable)
- [onEnable](Voip.md#onenable)
- [onTriggerEnter](Voip.md#ontriggerenter)
- [onTriggerExit](Voip.md#ontriggerexit)
- [onTriggerStay](Voip.md#ontriggerstay)
- [onValidate](Voip.md#onvalidate)
- [removeEventListener](Voip.md#removeeventlistener)
- [resolveGuids](Voip.md#resolveguids)
- [setWorldPosition](Voip.md#setworldposition)
- [setWorldQuaternion](Voip.md#setworldquaternion)
- [setWorldRotation](Voip.md#setworldrotation)
- [start](Voip.md#start)
- [startCoroutine](Voip.md#startcoroutine)
- [stopCoroutine](Voip.md#stopcoroutine)
- [update](Voip.md#update)
- [HasMicrophonePermissions](Voip.md#hasmicrophonepermissions)
...
▸ **getFrequency**(`userId`): ``null`` \| `number`
